...
<style scoped>
.learning-execution{flex:none;border-bottom:1px solid var(--sage-border);background:var(--sage-surface-muted)}
...
.learning-status{display:flex;gap:12px;overflow:auto;padding:0 18px 9px;color:var(--sage-text-muted);font-size:10px;white-space:nowrap}.learning-error,.learning-blocker{display:flex;align-items:center;gap:6px;margin:0;padding:0 18px 9px;color:var(--sage-danger);font-size:11px}.learning-artifact{max-height:210px;overflow:auto;border-top:1px solid var(--sage-border);padding:10px 18px;background:var(--sage-surface)}.learning-artifact pre{margin:0;color:var(--sage-text);font:11px/1.55 var(--sage-font-mono);white-space:pre-wrap}.learning-artifact ul{display:flex;gap:12px;margin:8px 0 0;padding:0;list-style:none;font-size:10px}.learning-artifact a{color:var(--sage-source)}
